---
description: End-of-session reflection. Logs what worked, what didn't, corrections received, and patterns learned to .opencode/reflections.md
...
Read `.opencode/reflections.md`. This is your persistent memory across sessions. If it doesn't exist, create it using the bootstrap structure below.
...
Append a new dated entry to `.opencode/reflections.md` under the `## Session Log` section.
...
### Bootstrap structure for `.opencode/reflections.md`
